 ...
 * (835 líneas) en la pasada de higiene: el panel queda como orquestador
 * y cada sección vive aquí con sus helpers compartidos.
 */
...
export function AISummarySection({ prediction, smartBets, match }: {
...
export function TacticalSection({ match, analysis, isLoading }: {
...
export function FormSection({ match, homeRecentMatches, awayRecentMatches, homeStats, awayStats }: {
  match: any
...
export function ContextSection({ match, analysis, isLoading }: {
  match: any; analysis: MatchAnalysis | null; isLoading: boolean
}) {
...
export function SmartBetsSection({ smartBets, analysis, odds, isLoading, match }: {
...
export function RisksSection({ analysis, injuries, match, isLoading }: {
...
export function ConclusionSection({ analysis, isLoading }: { analysis: MatchAnalysis | null; isLoading: boolean }) {
  if (isLoading) return <CardSkeleton lines={4} />
