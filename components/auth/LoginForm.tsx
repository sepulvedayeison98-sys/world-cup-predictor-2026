    ...
    <div className="card p-6 space-y-4">
      ...
      <button
        ...
        className={cn(
          ...
          'border border-zinc-700 bg-zinc-800 px-4 py-2.5',
      ...
      <form onSubmit={handleEmailAuth} className="space-y-3">
        <div>
          ...
          <input
            ...
            className={cn(
              'w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2.5',
              'text-sm text-zinc-200 placeholder:text-zinc-600',
              'focus:border-emerald-500/50 outline-none transition-colors'
            )}
          />
        </div>
        <div>
        ...
        {message && (
          <p className="rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-3 py-2 text-xs text-emerald-400">
            {message}
          </p>
        )}
